        ...
        <div className="row d-flex justify-content-center align-items-center">
          ...
          <div className="col-md-6 col-sm-12 my-5">
            <form
              ...
              data-netlify="true"
              method="POST"
              action="/personal-registration/?success=true"
            >
              <input
                type="hidden"
                name="form-name"
              ...
              />
              <label>Sponsor</label>
              <select className="form-control mb-3" name="sponsor">
                <option value="-">-</option>
              ...
              <select className="form-control mb-3" name="delegates">
                <option value="-">-</option>
              ...
              <select className="form-control mb-3" name="exhibition">
                <option value="-">-</option>
              ...
              <select className="form-control mb-3" name="other-sponsorship">
                <option value="-">-</option>
              ...
              <input className="form-control mb-3" type="text" name="hear" />
